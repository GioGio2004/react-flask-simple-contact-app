...
const ConactFrom = ({exsistingContact = {}, updateCallback})=>{
    ...
    const onSubmit = async (e)=>{
        ...
        const url = "http://127.0.0.1:5000/" + (updating ? `update_contact/${exsistingContact.id}` : "create_contact")
        const options = {
